import 'package:toolkit/data/models/systemUser/checklist/change_role_model.dart';
...
class ChecklistRepositoryImpl extends ChecklistRepository {
  ...
  @override
  Future<GetChecklistDetailsModel> fetchChecklistDetails(String checklistId) async {
    final response = await DioClient().get(
  ...
  @override
  Future<GetChecklistStatusModel> fetchChecklistStatus(String scheduleId) async {
    final response = await DioClient().get(
  ...
  @override
  Future<GetCheckListRolesModel> fetchRoles(String userId) async {
    final response = await DioClient().get(
        "${ApiConstants.baseUrl}/api/checklist/getroles?hashcode=vbdvrj9aN/gnmG9HRZBOV137+VBlDH1innvdsfSI8lOHTShvQP8iAcfeuRbflSG0|3|1|1|cet_3&userid=2ATY8mLx8MjkcnrmiRLvrA==");
    return GetCheckListRolesModel.fromJson(response);
  }
}
