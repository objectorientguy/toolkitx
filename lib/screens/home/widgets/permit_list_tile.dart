                      ...
                      child: ListTile(
                        ...
                        title: Row(
                          ...
                          children: [
                            Row(
                              children: [
                                Text(state.allPermitModel.data![index].permit!,
                        ...
                        subtitle: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                state.allPermitModel.data![index].description!,
                                maxLines: 3,
                              ),
                              const SizedBox(height: midTinySpacing),
                              IconAndTextRow(
                                  title: state
                                      .allPermitModel.data![index].location!,
                                  icon: 'location'),
                              const SizedBox(height: midTinySpacing),
                              Row(
                                crossAxisAlignment: CrossAxisAlignment.center,
                                ...
                                children: [
                                  IconAndTextRow(
                                      title: state
                                          .allPermitModel.data![index].pname!,
